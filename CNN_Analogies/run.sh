...
if [ "$1" = "train" ]; then
	...
	python run.py train --train-src=./data/ngram_local_train.abc --train-tgt=./data/ngram_local_train.d --dev-src=./data/ngram_local_val.abc --dev-tgt=./data/ngram_local_val.d --vocab=vocab.json 
