...
class NMT(nn.Module):
    ...
    """
    def __init__(self, embed_size, hidden_size, vocab,weights, dropout_rate=0.2):
        """ Init NMT Model.
        ...
        self.model_embeddings = ModelEmbeddings(embed_size, vocab,weights)
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        X = self.model_embeddings.source(source_padded) #cause source_padded already a tensor.
        pack_padded_X = pack_padded_sequence(X, source_lengths) 
    ...
    def save(self, path: str):
        ...
        params = {
            'args': dict(embed_size=self.model_embeddings.embed_size, hidden_size=self.hidden_size, weights=self.model_embeddings.source.weight, dropout_rate=self.dropout_rate),
            'vocab': self.vocab,
